...
const defaultContent: MultiLanguageContent = {
  en: {
    ...
    skills: {
      programmingLanguages: ["Python", "JavaScript", "C", "Java", "SQL", "PL/SQL"],
      frameworksLibraries: ["HTML", "CSS", "React", "Node.js", "Express.js", "Flask", "MongoDB"],
      databases: ["PostgreSQL", "MySQL", "MongoDB"],
      toolsTechnologies: ["Git", "Linux", "VS Code", "REST APIs", "Software Design", "Web Management"],
      aiMl: ["TensorFlow", "Keras", "DeepFace", "ESP32", "IoT", "Real-time Detection"],
    },
  },
  fr: {
    personalInfo: {
